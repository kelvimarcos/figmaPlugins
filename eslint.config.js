...
module.exports = tseslint.config(
  ...
  {
    // As regras do plugin da Figma precisam de informação de tipos.
    languageOptions: {
      parserOptions: {
        projectService: true,
  ...
  {
    // `tools/` são scripts de build em Node, fora do projeto TypeScript.
    ignores: ['build', 'dist', 'eslint.config.js', 'tools'],
  },
)
